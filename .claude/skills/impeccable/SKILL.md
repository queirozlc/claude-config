...
description: "Design, review, or improve frontend interfaces, including UI, UX, accessibility, performance, visual details, and design systems. Excludes backend-only work."
version: 4.1.1
user-invocable: true

...
<trigger>
You must use this skill for each command asking some change in a Ruby on Rails project.
</trigger>
...
| [guide.md](./references/guide.md)               | A general huge document that index, compact and detail all the concepts        |

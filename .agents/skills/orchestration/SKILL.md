---
name: orchestration
description: "Coordinate Orca agents with tracked tasks, messages, and results. Use for supervised workflows; use orca-cli for full handoffs and ordinary Orca control."
---

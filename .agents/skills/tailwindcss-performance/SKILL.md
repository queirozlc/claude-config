...
description: "Optimize Tailwind CSS performance, including build speed, CSS size, content detection, dynamic classes, caching, and critical CSS. Covers Tailwind v4."
---

...
description: "Guide Node.js and TypeScript development, including native type stripping, async code, streams, modules, testing, performance, caching, and logging."
metadata:
